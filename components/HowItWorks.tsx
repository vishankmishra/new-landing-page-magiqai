              ...
              >
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 bg-gradient-to-br from-magiq-600 to-accent-600 text-white rounded-lg flex items-center justify-center font-bold text-lg shadow-lg shadow-magiq-500/30">
                      {step.number}
                    </div>
                  </div>
                ...
                {steps.map((step, index) => (
                  ...
                  >
                    ...
                    <div className="flex justify-center mb-6 relative z-10 flex-shrink-0">
                      <div className="w-16 h-16 bg-gradient-to-br from-magiq-600 to-accent-600 text-white rounded-full flex items-center justify-center font-bold text-2xl shadow-xl shadow-magiq-500/40 border-4 border-white">
                        {step.number}
                      </div>
                    </div>
                    ...
                    {/* Card Content */}
                    <div className="glass-panel p-4 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col flex-grow">
