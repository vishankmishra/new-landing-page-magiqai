...
export default function Community({ title, subtitle, items }: CommunityProps) {
  return (
      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {items.map((item, index) => (
            ...
            >
              {/* Icon placeholder */}
              <div className="w-14 h-14 bg-gradient-to-br from-primary-500 to-purple-600 rounded-xl flex items-center justify-center mb-6">
                {index === 0 && (
                  <svg
