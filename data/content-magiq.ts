...
export const magiqContent = {
  ...
  hero: {
    ...
    headline: "AI That Knows Your Next Best Deal.",
    subheadline:
      "MagiQ AI predicts which prospects will actually buy before your first call. Get AI-generated sales strategies, decision-maker intelligence, and personalized outreach that converts.",
    primaryCTA: {
  ...
  socialProof: {
    title:
      "Used daily by sales teams across India, Singapore, Malaysia, UAE, and United States",
    logos: [
  ...
  solution: {
    headline:
      "What If You Could See Which Deals Will Close Before Your First Call?",
    subheadline:
    ...
    steps: [
      {
        ...
        description: "Identify your perfect customer.",
        details: [
          "Industry, size, geography criteria",
          "Tech stack and integrations",
          "Growth indicators and signals",
        ],
      },
      {
        number: 2,
        ...
        description:
          "AI scans global markets for accounts that match your ICP.",
        details: [
          "Firmographic matching (company traits)",
          "Technographic fit (tools they use)",
          "Intent signal alignment (buying readiness)",
        ],
      },
      {
        number: 3,
        title: "See Win Probability Score",
        description: "Every account gets scored 0-100. Focus on 70+ scores.",
        details: [
          "Budget and need alignment",
          "Executive intent and timing",
      ...
      },
      {
        ...
        description: "AI generates a custom sales strategy for every account.",
        details: [
      ...
      },
      {
        ...
        description: "AI writes contextual emails for each decision-maker.",
        details: [
      ...
      },
      {
        ...
        description: "Focus only on high-probability opportunities.",
        details: [
  ...
  testimonials: {
    ...
    items: [
      {
        quote:
          "MagiQ AI cut our research time from 3 weeks to 3 hours. My team now focuses only on accounts with real buying intent. Our close rate jumped from 2% to 11% in three months. That's a complete transformation.",
        author: "Rahul Mehta",
        role: "VP of Sales",
      ...
      {
        quote:
          "We tried Apollo, ZoomInfo, LinkedIn Sales Navigator. None told us which deals we'd actually win. MagiQ AI's Win Probability Score changed everything. We finally prioritize the right accounts and our forecast accuracy went from 60% to 92%.",
        author: "Sarah Lim",
      ...
      {
        quote:
          "As a startup with 3 AEs, we can't afford to chase dead leads. MagiQ AI helps us compete with 50-person sales teams. The AI strategy feature alone is worth 10X the price. It's like having a sales consultant for every deal.",
  ...
  useCases: {
    ...
    cases: [
      ...
      },
      {
        ...
        bestFor:
          "International Sales Leaders, Regional VPs, Global Account Teams",
      },
    ],
  },
  ...
  pricing: {
    ...
    subheadline:
      "1 credit = $1. No subscriptions. No hidden fees. Use only what you need.",
    creditPacks: [
      {
        name: "Starter Pack",
        credits: 100,
    ...
    featureCosts: [
      {
        name: "Sales Intelligence Summary",
        description: "Export a 3-page summary w/ MagiQ strategy",
        credits: 0,
      },
      {
        name: "Sales Chatbot",
      ...
      },
      {
        ...
        description: "Generate crafted email via MagiQ",
        credits: 0,
      },
      {
        name: "Contact Email",
        description: "Fetch verified email",
        credits: 1,
      },
      {
        name: "Stakeholder Intelligence",
        description: "Insights about stakeholders",
        credits: 1,
      },
      {
        name: "Import Bulk Stakeholders",
        description: "Upload multiple stakeholders",
        credits: 1,
      },
      {
        name: "Contact Phone",
        description: "Fetch verified phone number",
        credits: 2,
      },
      {
        name: "Account Intelligence",
        description: "Deep insights per company",
        credits: 5,
      },
      {
        name: "HubSpot Campaign Integration",
        description: "Sync with HubSpot campaigns",
        credits: 5,
      },
      {
        name: "Import Bulk Accounts",
        description: "Upload multiple accounts",
        credits: 5,
      },
    ],
    notes: [
